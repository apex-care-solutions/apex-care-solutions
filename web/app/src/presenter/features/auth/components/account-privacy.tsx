        ...
        <div className="bg-neutral-100 p-3">
            ...
            <Card className="w-full bg-white mb-3">
                ...
                <CardContent>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Get alerts about upcoming maintenance and service
                        reminders.
                    </p>
                </CardContent>
            </Card>
            <Card className="w-full bg-white mb-3">
                ...
                <CardContent>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Allow technicians to view maintenance logs to improve
                        service quality.
                    </p>
                </CardContent>
            </Card>
            <Card className="w-full bg-white mb-3">
                ...
                <CardContent>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                        Control who can access your maintenance and service
                        history.
                    </p>
                </CardContent>
            </Card>
            <Card className="w-full bg-white mb-3">
                <CardFooter className="pt-4 flex w-full">
                    <Button
                        size="default"
                        className="bg-black text-white hover:text-primary-foreground hover:bg-muted-foreground w-full"
                    >
                        Confirm
                    </Button>
                </CardFooter>
